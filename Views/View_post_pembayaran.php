...
<form action="../Config/Routes.php?function=create_pembayaran" method="POST">
    ...
    <table border="1">
        <input type="number" name="id_pembayaran" onKeyPress="return numberOnly(event);" required>
        <tr>
            <td>ID Petugas</td>
            <td>
        ...
        <tr>
            <td>Tahun Bayar</td>
            <td><input type="number" name="tahun_bayar" onKeyPress="return numberOnly(event);" required></td>
        </tr>
